...
train_gen = DataGenerator(train_data, train_labels, base_dir, (31, 31, 31), batch_size=batch_size, shuffle=True)
...
use_multiprocessing = True, class_weight=class_weight_dict, workers=10)
#,class_weight=None
